...
function MainQuestion() {
  ...
  useEffect(() => {
    async function getFunctionDetails() {
      await axios
        .get(`https://stackoverflow-serverside.herokuapp.com/api/question/${id}`)
  ...
  const handleSubmit = async () => {
    ...
    await axios
      .post("https://stackoverflow-serverside.herokuapp.com/api/answer", body, config)
      .then(() => {
  ...
  const handleComment = async () => {
    if (comment !== "") {
      ...
      await axios.post(`https://stackoverflow-serverside.herokuapp.com/api/comment/${id}`, body).then((res) => {
        setComment("");
        setShow(false);
        getUpdatedAnswer();
